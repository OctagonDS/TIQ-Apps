...
const GradientBtnCacheDisable = ({ name }) => (
  <LinearGradient
                                ...
                                <View>
                                  <View style={{ width: '100%' }}>
                                    <TouchableOpacity
                                      ...
                                      onPress={async () => {}}
                                    >
                                      <GradientBtnCacheDisable name="Zwischenspeicher" />
                                    </TouchableOpacity>
                                  </View>
                                </View>
                                <View>
                            ...
                            <View>
                              ...
                              <View style={{ marginTop: 20, width: '100%' }}>
                                <TouchableOpacity
                                  ...
                                  onPress={() => {}}
                                >
                                  <GradientBtnCacheDisable name="Als abgeschlossen markieren" />
                                </TouchableOpacity>
                              </View>
                            </View>
                          ) : (
                  ...
                  >
                    <TouchableOpacity
                      style={{
                        borderBottomWidth: item.id == moduleId ? 2 : 0,
                        borderColor:
                          item.id == moduleId ? '#FF741F' : '#454A4F',
                      }}
                      onPress={() => {
                        navigation.setParams({
                          moduleId: item.id,
                    ...
                    {itemAcc.id == moduleId ? (
                      <View>
                        <TouchableOpacity onPress={() => Accordion()}>
                          ...
                          >
                            <Text
                              style={{ color: '#fff', fontFamily: 'ub-reg' }}
                            >
                              {itemAcc.preview_title}
                            </Text>
                            <Text
